<template>
  <div class="center_swiper">
    <ul>
    <li class="swiper_main" v-for="(pic,index) in pics" v-show="index === mark"  :key="index">
      <a :href="pic.href">
        <img :src="pic.imgUrl">
...
<style>
.center_swiper .swiper_main {
  position:relative;
  animation: centerswiper 5s infinite;
}
@keyframes centerswiper {
  0% {left: -868px}
  50% {left: 0}
  100% {left: 868px}
}
